...
function(React, moment) {
  ...
  var Commit = React.createClass({
    render: function() {
      ...
      var url = this.props.branch ? `http://github.com/${this.props.repo.owner}/${this.props.repo.name}/commits/${this.props.branch.name}` : `http://github.com/${this.props.repo.owner}/${this.props.repo.name}`;
        ...
        <article className="commit row row-top">
          ...
          <div className="commit-details cell">
            ...
            <div className="commit-meta">
              ...
              {' '}to{' '}
              <a href={url} title={`View ${this.props.repo.owner}/${this.props.repo.name} on Github`} target="_blank">
